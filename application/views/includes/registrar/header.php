...
<body class="">
  ...
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
				<a href="<?php echo base_url('registrar'); ?>" class="simple-text logo-mini">
          <i class="material-icons">timeline</i>
        </a>
        <a href="<?php echo base_url('registrar'); ?>" class="simple-text logo-normal">
          OADRS
        </a>
      </div>
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="nav-item  <?php echo ($mainContent == 'registrar/index') ? 'active':''; ?>">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse <?php echo ($mainContent == 'registrar/createNewUser') ? 'show':''; ?>" id="pagesExamples">
              <ul class="nav " >
                <li class="nav-item <?php echo ($mainContent == 'registrar/createNewUser') ? 'active':''; ?>">
                  <a class="nav-link" href="<?php echo base_url('registrar/createNewUser'); ?>">
                    <span class="sidebar-mini"> CNU </span>
                    <span class="sidebar-normal"> Create New User </span>
                  </a>
                </li>
                <li class="nav-item ">
