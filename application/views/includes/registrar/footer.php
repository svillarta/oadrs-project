...
$().ready(function() {
	...
	$('.fixed-plugin .img-holder').click(function() {
		...
		if ($('.switch-sidebar-image input:checked').length == 0) {
			...
			$sidebar_img_container.css('background-image', 'url("<?php echo base_url(); ?>' + new_image + '")');
			$full_page_background.css('background-image', 'url("<?php echo base_url(); ?>' + new_image_full_page + '")');
		}

		if ($sidebar_responsive.length != 0) {
			$sidebar_responsive.css('background-image', 'url("<?php echo base_url(); ?>' + new_image + '")');
		}
	});
...
$('#facebook').sharrre({
	...
	url: 'https://demos.creative-tim.com/material-dashboard-pro/examples/'
});
