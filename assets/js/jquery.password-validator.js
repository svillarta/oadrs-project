 ...
 */
  ...
  $(document).ready(function() {
    ...
    $("#password").passwordValidation({"confirmField": "#confirmPassword"}, function(element, valid, match, failedCases) {

        $("#errors").html("<pre>" + failedCases.join("\n") + "</pre>");
      
         if(valid) $(element).css("border-bottom","2px solid green");
         if(!valid) $(element).css("border-bottom","2px solid red");
         if(valid && match) $("#confirmPassword").css("border-bottom","2px solid green");
         if(!valid || !match) $("#confirmPassword").css("border-bottom","2px solid red");
    });
  });
